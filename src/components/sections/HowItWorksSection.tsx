...
const ProcessCard = ({ 
  ...
  <div className="min-w-full h-full flex items-center justify-center p-8 md:p-16">
    <div className="container-premium grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-6xl">
      {/* Content */}
      <motion.div 
      ...
      >
        <div className="mb-8">
          <span className="text-7xl md:text-8xl font-ultralight text-primary-500/20 block leading-none">
            {num}
          </span>
          <h3 className="text-title font-light text-white mt-4 mb-6">
            {title}
          </h3>
          <p className="text-body-large text-gray-300 leading-relaxed mb-8">
            {description}
          </p>
        </div>
      ...
      <motion.div 
        ...
        className="relative"
      >
        <div className="glass rounded-3xl p-8 shadow-premium border border-gray-800/50 bg-gradient-to-br from-gray-900/50 to-gray-950/50">
...
export default function HowItWorksSection() {
  ...
  return (
    <section ref={containerRef} className="relative h-[300vh] bg-gray-950 border-t border-gray-800/50">
      {/* Section Header */}
      <div className="absolute top-0 left-0 right-0 z-50 bg-gray-950/90 backdrop-blur-xl border-b border-gray-800/50">
